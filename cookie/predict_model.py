...
from models.model import Network, predict_single_sample, load_checkpoint
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('model_path', type=str, nargs='?', help='Path to the pre-trained model file', default='models/trained_model.pth')
    parser.add_argument('data_path', type=str, nargs='?', help='Path to the input data file (e.g., folder or numpy file)', default='data/example_images')
